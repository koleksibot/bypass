...
**403bypass** automates the techniques used to circumvent access control restrictions on target pages. **403bypass** will continue to be improved and it is open to contributions.
...
**Usage 1:** `python3 run.py -u https://example.com -d /secret`<br>
**Usage 2:** `python3 run.py -u https://example.com -D dirlist.txt`<br>
**Usage 3:** `python3 run.py -U urllist.txt -d /secret`<br>
**Usage 4:** `python3 run.py -U urllist.txt -D dirlist.txt`<br>
...
- `python3 run.py -u https://example.com -d secret`<br>
- `python3 run.py -u https://example.com -d /secret`<br>
- `python3 run.py -u https://example.com -d /secret/`<br>
- `python3 run.py -u https://example.com -d secret/`<br>
- `python3 run.py -u https://example.com/ -d secret`<br>
...
For example: <br>
`python3 run.py -u https://example.com -d /secret` is given. Then the output is saved to `example.txt` in the current directory.
***
