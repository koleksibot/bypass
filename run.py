...
print(Fore.GREEN + Style.BRIGHT + "____________________ 403Bypass ____________________\n")
print(Fore.LIGHTMAGENTA_EX + Style.BRIGHT + "-----> Facebook   : ahmad chen wang xuesi\n")
print(Fore.MAGENTA + Style.BRIGHT + "-----> GitHub    : https://github.com/koleksibot\n")
print(Fore.BLUE + Style.BRIGHT + custom_fig.renderText('-------------') + Style.RESET_ALL)
# DISPLAY BANNER -- END
